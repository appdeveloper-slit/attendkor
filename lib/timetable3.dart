...
class TimeTable3 extends StatefulWidget {
  ...
  const TimeTable3({super.key, required this.sUsertype});

  @override
  State<TimeTable3> createState() => _TimeTable3State();
}

class _TimeTable3State extends State<TimeTable3> with TickerProviderStateMixin {
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        // _showCodeDialog(ctx);
                        Navigator.pop(ctx);
                        // STM().redirect2page(ctx, TimeTable2());
