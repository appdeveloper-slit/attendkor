import 'package:attend_kor_teacher/timetable.dart';
              ...
              Container(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: lectureDetails == null ? Container() : Column(
  ...
  void getattendance({value, type, apiname}) async {
    ...
    setState(() {
      switch (apiname) {
        ...
        case "delete_attendance":
          if (success) {
            STM().successDialogWithReplace(ctx, '${result['message']}', Attendance(id: widget.id));
          }
          break;
        case "get_student_details":
          if (success) {
